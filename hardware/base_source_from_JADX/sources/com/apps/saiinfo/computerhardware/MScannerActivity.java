...
public class MScannerActivity extends AppCompatActivity {
    CardView one;
    CardView three;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_mscanner);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MScannerActivity.this.startActivity(new Intent(MScannerActivity.this, MScanUseActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MScannerActivity.this.startActivity(new Intent(MScannerActivity.this, MScanInActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MScannerActivity.this.startActivity(new Intent(MScannerActivity.this, MScanActivity.class));
            }
        });
