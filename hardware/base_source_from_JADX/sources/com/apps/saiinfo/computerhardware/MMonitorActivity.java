...
public class MMonitorActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_mmonitor);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MMonitorActivity.this.startActivity(new Intent(MMonitorActivity.this, MMonActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MMonitorActivity.this.startActivity(new Intent(MMonitorActivity.this, MMonConnectActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MMonitorActivity.this.startActivity(new Intent(MMonitorActivity.this, AppsActivity.class));
            }
        });
