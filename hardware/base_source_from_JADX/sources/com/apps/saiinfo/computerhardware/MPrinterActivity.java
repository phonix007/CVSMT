...
public class MPrinterActivity extends AppCompatActivity {
    CardView one;
    CardView three;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_mprinter);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MPrinterActivity.this.startActivity(new Intent(MPrinterActivity.this, MPrintsActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MPrinterActivity.this.startActivity(new Intent(MPrinterActivity.this, MPrintInActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MPrinterActivity.this.startActivity(new Intent(MPrinterActivity.this, MPrintActivity.class));
            }
        });
