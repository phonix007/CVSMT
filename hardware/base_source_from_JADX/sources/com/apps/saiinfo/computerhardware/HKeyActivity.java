...
public class HKeyActivity extends AppCompatActivity {
    CardView five;
    CardView four;
    CardView one;
    CardView three;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_hkey);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HKeyActivity.this.startActivity(new Intent(HKeyActivity.this, HKeysActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HKeyActivity.this.startActivity(new Intent(HKeyActivity.this, HKeyNameActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HKeyActivity.this.startActivity(new Intent(HKeyActivity.this, HFunActivity.class));
            }
        });
        this.four = (CardView) findViewById(C0508R.C0510id.four);
        this.four.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HKeyActivity.this.startActivity(new Intent(HKeyActivity.this, HKeyConnectActivity.class));
            }
        });
        this.five = (CardView) findViewById(C0508R.C0510id.five);
        this.five.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HKeyActivity.this.startActivity(new Intent(HKeyActivity.this, AppsActivity.class));
            }
        });
