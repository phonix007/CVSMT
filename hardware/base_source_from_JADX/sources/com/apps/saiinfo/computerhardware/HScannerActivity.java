...
public class HScannerActivity extends AppCompatActivity {
    CardView one;
    CardView three;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_hscanner);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HScannerActivity.this.startActivity(new Intent(HScannerActivity.this, HScanUseActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HScannerActivity.this.startActivity(new Intent(HScannerActivity.this, HScanInActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HScannerActivity.this.startActivity(new Intent(HScannerActivity.this, HScanActivity.class));
            }
        });
