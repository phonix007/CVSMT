...
public class HHardActivity extends AppCompatActivity {
    CardView one;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_hhard);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HHardActivity.this.startActivity(new Intent(HHardActivity.this, HDiskActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HHardActivity.this.startActivity(new Intent(HHardActivity.this, HHDActivity.class));
            }
        });
