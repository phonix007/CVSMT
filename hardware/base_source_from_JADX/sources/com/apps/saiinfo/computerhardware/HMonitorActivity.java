...
public class HMonitorActivity extends AppCompatActivity {
    CardView one;
    CardView three;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_hmonitor);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HMonitorActivity.this.startActivity(new Intent(HMonitorActivity.this, HMonActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HMonitorActivity.this.startActivity(new Intent(HMonitorActivity.this, HMonConnectActivity.class));
            }
        });
        this.three = (CardView) findViewById(C0508R.C0510id.three);
        this.three.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HMonitorActivity.this.startActivity(new Intent(HMonitorActivity.this, AppsActivity.class));
            }
        });
