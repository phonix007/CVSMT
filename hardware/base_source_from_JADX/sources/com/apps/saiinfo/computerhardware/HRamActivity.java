...
public class HRamActivity extends AppCompatActivity {
    CardView one;
    CardView two;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0508R.layout.activity_hram);
        this.one = (CardView) findViewById(C0508R.C0510id.one);
        this.one.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HRamActivity.this.startActivity(new Intent(HRamActivity.this, HRamsActivity.class));
            }
        });
        this.two = (CardView) findViewById(C0508R.C0510id.two);
        this.two.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HRamActivity.this.startActivity(new Intent(HRamActivity.this, HRamInActivity.class));
            }
        });
