...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo8233id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo8233id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo8233id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo8236id = 1) int i, @SafeParcelable.Param(mo8236id = 2) int i2, @SafeParcelable.Param(mo8236id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo8236id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
