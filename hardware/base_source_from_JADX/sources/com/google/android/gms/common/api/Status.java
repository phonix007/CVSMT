...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.VersionField(mo8239id = 1000)
    private final int zzg;
    @SafeParcelable.Field(getter = "getStatusCode", mo8233id = 1)
    private final int zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", mo8233id = 3)
    private final PendingIntent zzi;
    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", mo8233id = 2)
    private final String zzj;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo8236id = 1000) int i, @SafeParcelable.Param(mo8236id = 1) int i2, @Nullable @SafeParcelable.Param(mo8236id = 2) String str, @Nullable @SafeParcelable.Param(mo8236id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
