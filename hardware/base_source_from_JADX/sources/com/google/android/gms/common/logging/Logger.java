...
public class Logger {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo8275v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo8270d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public void mo8273i(String str, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: w */
    public void mo8276w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo8272e(String str, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo8271e(String str, Throwable th, @Nullable Object... objArr) {
