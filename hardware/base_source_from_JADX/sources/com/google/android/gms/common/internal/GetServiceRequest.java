...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    GetServiceRequest(@SafeParcelable.Param(mo8236id = 1) int i, @SafeParcelable.Param(mo8236id = 2) int i2, @SafeParcelable.Param(mo8236id = 3) int i3, @SafeParcelable.Param(mo8236id = 4) String str, @SafeParcelable.Param(mo8236id = 5) IBinder iBinder, @SafeParcelable.Param(mo8236id = 6) Scope[] scopeArr, @SafeParcelable.Param(mo8236id = 7) Bundle bundle, @SafeParcelable.Param(mo8236id = 8) Account account, @SafeParcelable.Param(mo8236id = 10) Feature[] featureArr, @SafeParcelable.Param(mo8236id = 11) Feature[] featureArr2, @SafeParcelable.Param(mo8236id = 12) boolean z) {
        this.version = i;
        this.zzdf = i2;
        this.zzdg = i3;
