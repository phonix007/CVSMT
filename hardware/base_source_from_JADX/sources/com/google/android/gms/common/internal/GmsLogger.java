...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo8202d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo8203d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo8211v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo8212v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo8207i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo8208i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo8213w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo8214w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo8204e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo8205e(String str, String str2, Throwable th) {
        if (canLog(6)) {
