...
public final class zzk extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAllowTestKeys", mo8233id = 3)
    private final boolean zzaa;
    @SafeParcelable.Field(getter = "getCallingPackage", mo8233id = 1)
    private final String zzy;
    @SafeParcelable.Field(getter = "getCallingCertificateBinder", mo8233id = 2, type = "android.os.IBinder")
    @Nullable
    private final zze zzz;

    @SafeParcelable.Constructor
    zzk(@SafeParcelable.Param(mo8236id = 1) String str, @SafeParcelable.Param(mo8236id = 2) @Nullable IBinder iBinder, @SafeParcelable.Param(mo8236id = 3) boolean z) {
        this.zzy = str;
