...
public final class zzayh {
    ...
    public static boolean zzah(Context context) {
        ...
        try {
            ...
            if ((resolveActivity.activityInfo.configChanges & 16) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"keyboard"}));
                z = false;
            } else {
                z = true;
            }
            if ((resolveActivity.activityInfo.configChanges & 32) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"keyboardHidden"}));
                z = false;
            }
            if ((resolveActivity.activityInfo.configChanges & 128) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"orientation"}));
                z = false;
            }
            if ((resolveActivity.activityInfo.configChanges & 256) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"screenLayout"}));
                z = false;
            }
            if ((resolveActivity.activityInfo.configChanges & 512) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"uiMode"}));
                z = false;
            }
            if ((resolveActivity.activityInfo.configChanges & 1024) == 0) {
                zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"screenSize"}));
                z = false;
            }
            if ((resolveActivity.activityInfo.configChanges & 2048) != 0) {
                return z;
            }
            zzaxz.zzeo(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", new Object[]{"smallestScreenSize"}));
            return false;
        } catch (Exception e) {
    ...
    public final void zza(Context context, List<String> list) {
        if (context instanceof Activity) {
            ...
            if (!TextUtils.isEmpty(zzbwi.zzbp(activity))) {
                if (list == null) {
                    zzaxz.m30v("Cannot ping urls: empty list.");
                } else if (!zzabk.zzj(context)) {
                    zzaxz.m30v("Cannot ping url because custom tabs is not supported");
                } else {
    ...
    public final boolean zzai(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzayo(this, (zzayk) null), intentFilter);
        this.zzele = true;
        return true;
    }
    ...
    public final boolean zzaj(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzayn(this, (zzayk) null), intentFilter);
        this.zzelf = true;
        return true;
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int[] zzi(android.app.Activity r7) {
        /*
            r6 = this;
        ...
        L_0x0025:
            ...
            r1 = r4[r3]
            int r1 = com.google.android.gms.internal.ads.zzbat.zzb((android.content.Context) r7, (int) r1)
            r0[r3] = r1
            com.google.android.gms.internal.ads.zzwu.zzpv()
            r1 = r4[r2]
            int r7 = com.google.android.gms.internal.ads.zzbat.zzb((android.content.Context) r7, (int) r1)
            r0[r2] = r7
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzayh.zzi(android.app.Activity):int[]");
    }
    ...
    public final boolean zza(android.view.View r4, android.os.PowerManager r5, android.app.KeyguardManager r6) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzaac<java.lang.Boolean> r5 = com.google.android.gms.internal.ads.zzaan.zzcst
    ...
    public static WebResourceResponse zzd(HttpURLConnection httpURLConnection) throws IOException {
        ...
        return zzbv.zzlh().zza(str2, str3, httpURLConnection.getResponseCode(), httpURLConnection.getResponseMessage(), hashMap, httpURLConnection.getInputStream());
    }
