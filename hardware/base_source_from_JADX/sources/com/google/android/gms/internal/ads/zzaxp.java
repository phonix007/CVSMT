...
public final class zzaxp {
    ...
    public final void zzb(com.google.android.gms.internal.ads.zzwb r11, long r12) {
        /*
            ...
            monitor-enter(r0)
            com.google.android.gms.internal.ads.zzayb r1 = r10.zzejs     // Catch:{ all -> 0x007c }
            long r1 = r1.zzzj()     // Catch:{ all -> 0x007c }
            com.google.android.gms.common.util.Clock r3 = com.google.android.gms.ads.internal.zzbv.zzlm()     // Catch:{ all -> 0x007c }
            long r3 = r3.currentTimeMillis()     // Catch:{ all -> 0x007c }
            long r5 = r10.zzejn     // Catch:{ all -> 0x007c }
            r7 = -1
            int r9 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
            if (r9 != 0) goto L_0x0042
            long r1 = r3 - r1
            com.google.android.gms.internal.ads.zzaac<java.lang.Long> r5 = com.google.android.gms.internal.ads.zzaan.zzcrn     // Catch:{ all -> 0x007c }
            com.google.android.gms.internal.ads.zzaak r6 = com.google.android.gms.internal.ads.zzwu.zzpz()     // Catch:{ all -> 0x007c }
        ...
        L_0x0033:
            com.google.android.gms.internal.ads.zzayb r1 = r10.zzejs     // Catch:{ all -> 0x007c }
            int r1 = r1.zzzk()     // Catch:{ all -> 0x007c }
            r10.zzejp = r1     // Catch:{ all -> 0x007c }
        L_0x003b:
            r10.zzejn = r12     // Catch:{ all -> 0x007c }
            long r12 = r10.zzejn     // Catch:{ all -> 0x007c }
        ...
        L_0x0044:
            ...
            android.os.Bundle r13 = r11.extras     // Catch:{ all -> 0x007c }
            if (r13 == 0) goto L_0x0058
            android.os.Bundle r11 = r11.extras     // Catch:{ all -> 0x007c }
            ...
            return
        L_0x0058:
            int r11 = r10.zzejo     // Catch:{ all -> 0x007c }
            int r11 = r11 + r12
            r10.zzejo = r11     // Catch:{ all -> 0x007c }
            int r11 = r10.zzejp     // Catch:{ all -> 0x007c }
            int r11 = r11 + r12
            ...
            com.google.android.gms.internal.ads.zzayb r11 = r10.zzejs     // Catch:{ all -> 0x007c }
            r11.zzav(r3)     // Catch:{ all -> 0x007c }
            goto L_0x007a
        L_0x0070:
            com.google.android.gms.internal.ads.zzayb r11 = r10.zzejs     // Catch:{ all -> 0x007c }
            long r11 = r11.zzzl()     // Catch:{ all -> 0x007c }
            r13 = 0
            long r3 = r3 - r11
            r10.zzejq = r3     // Catch:{ all -> 0x007c }
        L_0x007a:
            monitor-exit(r0)     // Catch:{ all -> 0x007c }
            return
        L_0x007c:
