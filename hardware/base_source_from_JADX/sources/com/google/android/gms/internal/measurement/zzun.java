...
public abstract class zzun implements Serializable, Iterable<Byte> {
    ...
    private static final zzut zzbuv = (zzuk.zzui() ? new zzuy((zzuo) null) : new zzur((zzuo) null));
    ...
    public final String zzuk() {
        return size() == 0 ? BuildConfig.FLAVOR : zza(zzvz.UTF_8);
    }
