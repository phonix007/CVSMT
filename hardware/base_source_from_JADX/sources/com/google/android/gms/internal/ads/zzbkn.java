    ...
    public final zzbjr zza(zzbpu zzbpu) throws GeneralSecurityException {
        try {
            ...
            if (zzx instanceof zzbmf) {
                ...
                ECPrivateKeySpec eCPrivateKeySpec = new ECPrivateKeySpec(new BigInteger(1, byteArray), zzbog.zza(zza));
                return new zzbob((ECPrivateKey) zzbol.zzfjx.zzfu("EC").generatePrivate(eCPrivateKeySpec), zzahe.zzaht().toByteArray(), zzbku.zza(zzahe.zzahs()), zzbku.zza(zzahc.zzahg()), new zzbkw(zzahc.zzahf().zzagz()));
            }
