...
final class zzvo<FieldDescriptorType extends zzvq<FieldDescriptorType>> {
    ...
    public final boolean isInitialized() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzc : this.zzbwl.zzyk()) {
            if (!zzc(zzc)) {
                return false;
            }
        }
    ...
    private static boolean zzc(Map.Entry<FieldDescriptorType, Object> entry) {
        zzvq zzvq = (zzvq) entry.getKey();
        if (zzvq.zzwh() == zzzg.MESSAGE) {
            if (zzvq.zzwi()) {
    ...
    public final void zza(zzvo<FieldDescriptorType> zzvo) {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzd : zzvo.zzbwl.zzyk()) {
            zzd(zzd);
        }
    }
    ...
    private final void zzd(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (zzvq.zzwi()) {
            ...
            this.zzbwl.put(zzvq, zza);
        } else if (zzvq.zzwh() == zzzg.MESSAGE) {
            Object zza2 = zza(zzvq);
            if (zza2 == null) {
                this.zzbwl.put(zzvq, zzz(value));
                return;
            }
            if (zza2 instanceof zzxk) {
                obj = zzvq.zza((zzxk) zza2, (zzxk) value);
            } else {
                obj = zzvq.zza(((zzxe) zza2).zzwo(), (zzxe) value).zzwv();
            }
            this.zzbwl.put(zzvq, obj);
        } else {
            this.zzbwl.put(zzvq, zzz(value));
        }
    }
    ...
    public final int zzwe() {
        ...
        for (int i2 = 0; i2 < this.zzbwl.zzyj(); i2++) {
            ...
            i += zzb((zzvq<?>) (zzvq) zzbw.getKey(), zzbw.getValue());
        }
        for (Map.Entry next : this.zzbwl.zzyk()) {
            i += zzb((zzvq<?>) (zzvq) next.getKey(), next.getValue());
        }
        return i;
    }
    ...
    public final int zzwf() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zze : this.zzbwl.zzyk()) {
            i += zze(zze);
        }
        return i;
    }
    ...
    private static int zze(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (zzvq.zzwh() != zzzg.MESSAGE || zzvq.zzwi() || zzvq.zzwj()) {
            return zzb((zzvq<?>) zzvq, value);
        }
        if (value instanceof zzwh) {
            return zzve.zzb(((zzvq) entry.getKey()).zzc(), (zzwl) (zzwh) value);
        }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zzbwl.zzyj(); i++) {
            ...
            zzvo.zza((zzvq) zzbw.getKey(), zzbw.getValue());
        }
        for (Map.Entry next : this.zzbwl.zzyk()) {
            zzvo.zza((zzvq) next.getKey(), next.getValue());
        }
