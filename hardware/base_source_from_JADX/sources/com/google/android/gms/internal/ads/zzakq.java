...
public final class zzakq {
    ...
    public zzakq(JSONObject jSONObject) throws JSONException {
        ...
        this.zzdli = jSONObject.optString("html_template", (String) null);
        this.zzdlj = jSONObject.optString("ad_base_url", (String) null);
        ...
        this.zzdln = jSONObject.optString("response_type", (String) null);
