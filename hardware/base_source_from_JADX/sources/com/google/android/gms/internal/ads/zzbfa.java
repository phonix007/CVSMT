...
final class zzbfa implements zzov {
    ...
    public final long zza(zzoz zzoz) throws IOException {
        ...
        if (zzoz4.zzaha >= this.zzewf) {
            ...
            zzoz2 = new zzoz(zzoz4.uri, j2, j, (String) null);
        }
        if (zzoz4.zzcc == -1 || zzoz4.zzaha + zzoz4.zzcc > this.zzewf) {
            zzoz3 = new zzoz(zzoz4.uri, Math.max(this.zzewf, zzoz4.zzaha), zzoz4.zzcc != -1 ? Math.min(zzoz4.zzcc, (zzoz4.zzaha + zzoz4.zzcc) - this.zzewf) : -1, (String) null);
        } else {
            zzoz3 = null;
        }
        long j3 = 0;
    ...
    public final int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (this.zzewh < this.zzewf) {
            i3 = this.zzewe.read(bArr, i, (int) Math.min((long) i2, this.zzewf - this.zzewh));
            this.zzewh += (long) i3;
        } else {
            i3 = 0;
        }
