...
class zzxx<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public List<zzye> zzccw;
    /* access modifiers changed from: private */
    public Map<K, V> zzccx;
    private volatile zzyg zzccy;
    /* access modifiers changed from: private */
    public Map<K, V> zzccz;
    ...
    public V get(Object obj) {
        ...
        if (zza >= 0) {
            return this.zzccw.get(zza).getValue();
        }
    ...
    public final V put(K k, V v) {
        ...
        int zza = zza(k);
        if (zza >= 0) {
            return this.zzccw.get(zza).setValue(v);
        }
        zzym();
    ...
    public final V zzbx(int i) {
        zzym();
        V value = this.zzccw.remove(i).getValue();
        if (!this.zzccx.isEmpty()) {
            Iterator it = zzyn().entrySet().iterator();
            this.zzccw.add(new zzye(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zzccy == null) {
            this.zzccy = new zzyg(this, (zzxy) null);
        }
        return this.zzccy;
    }
    ...
    public final Set<Map.Entry<K, V>> zzyl() {
        if (this.zzcda == null) {
            this.zzcda = new zzya(this, (zzxy) null);
        }
        return this.zzcda;
    }
