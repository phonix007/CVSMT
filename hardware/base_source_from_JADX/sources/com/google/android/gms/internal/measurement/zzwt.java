...
final class zzwt implements zzxv {
    ...
    public final <T> zzxu<T> zzh(Class<T> cls) {
        ...
        if (zzf.zzxu()) {
            ...
            return zzxi.zza(cls, zzf, zzxn.zzxy(), zzwo.zzxl(), zzxw.zzyg(), (zzvl<?>) null, zzxb.zzxr());
        } else if (zza(zzf)) {
            return zzxi.zza(cls, zzf, zzxn.zzxx(), zzwo.zzxk(), zzxw.zzye(), zzvn.zzwc(), zzxb.zzxq());
        } else {
            return zzxi.zza(cls, zzf, zzxn.zzxx(), zzwo.zzxk(), zzxw.zzyf(), (zzvl<?>) null, zzxb.zzxq());
        }
    }
    ...
    private static zzxd zzxm() {
        try {
            return (zzxd) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
