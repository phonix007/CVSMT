...
public final class zzwe {
    ...
    public static zzwb zza(Context context, zzyx zzyx) {
        ...
        return new zzwb(8, time, networkExtrasBundle, gender, list, isTestDevice, zzqm, manualImpressionsEnabled, publisherProvidedId, zzzs, location, contentUrl, zzyx.zzql(), zzyx.getCustomTargeting(), Collections.unmodifiableList(new ArrayList(zzyx.zzqn())), zzyx.zzqi(), str, zzyx.isDesignedForFamilies(), (zzvv) null, zzyx.zzqo(), zzyx.zzqp());
    }
}
