...
final class zzvg implements zzzh {
    ...
    public final <K, V> void zza(int i, zzwx<K, V> zzwx, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.zzbva.zzc(i, 2);
            this.zzbva.zzaz(zzww.zza(zzwx, next.getKey(), next.getValue()));
            zzww.zza(this.zzbva, zzwx, next.getKey(), next.getValue());
        }
    }
}
