...
import com.google.android.gms.ads.C0522R;
...
public final class zzwi {
    ...
    public zzwi(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0522R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0522R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0522R.styleable.AdsAttrs_adSizes);
        ...
        this.zzboa = obtainAttributes.getString(C0522R.styleable.AdsAttrs_adUnitId);
