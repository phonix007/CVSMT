...
public final class zzlk implements zzlo, zzlp {
    ...
    public final void zza(zzfg zzfg, boolean z, zzlp zzlp) {
        ...
        zzlp.zzb(this.zzxi, (Object) null);
    }

    public final zzlm zza(int i, zzot zzot) {
        zzpo.checkArgument(i == 0);
        return new zzlc(this.uri, this.zzaxv.zzgs(), this.zzaxw.zzdz(), this.zzawn, this.zzwx, this.zzawo, this, zzot, (String) null, this.zzaxx);
    }
    ...
    public final void zzb(zzgc zzgc, Object obj) {
        ...
        if (!this.zzaxy || z) {
            this.zzxi = zzgc;
            this.zzaxy = z;
            this.zzawp.zzb(this.zzxi, (Object) null);
        }
    }
}
