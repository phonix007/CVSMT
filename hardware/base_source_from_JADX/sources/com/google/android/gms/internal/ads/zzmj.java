...
public final class zzmj<T extends zzml> implements zzlv, zzlw, zzpg<zzme> {
    ...
    public final long zzez() {
        ...
        if (!last.zzga()) {
            last = this.zzbaj.size() > 1 ? this.zzbaj.get(this.zzbaj.size() - 2) : null;
        }
        if (last != null) {
    ...
    public final boolean zzy(long j) {
        ...
        this.zzbaf.zza(this.zzbaj.isEmpty() ? null : this.zzbaj.getLast(), this.zzaxk != -9223372036854775807L ? this.zzaxk : j, this.zzbai);
    ...
    public final /* synthetic */ void zza(zzpi zzpi, long j, long j2, boolean z) {
        ...
        zzkt.zzd(zzme.zzazo, zzme.type, this.zzbac, zzme.zzazp, zzme.zzazq, zzme.zzazr, zzme.zzazs, zzme.zzazt, j, j2, zzme.zzfv());
        if (!z) {
            this.zzbal.zzh(true);
    ...
    public final /* synthetic */ void zza(zzpi zzpi, long j, long j2) {
        ...
        zzme zzme2 = zzme;
        zzkt zzkt2 = zzkt;
        zzkt2.zzc(zzme.zzazo, zzme.type, this.zzbac, zzme.zzazp, zzme.zzazq, zzme.zzazr, zzme.zzazs, zzme.zzazt, j, j2, zzme2.zzfv());
        this.zzbag.zza(this);
    }
}
