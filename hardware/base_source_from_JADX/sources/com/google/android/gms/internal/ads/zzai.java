...
public abstract class zzai implements zzar {
    ...
    public final HttpResponse zzb(zzr<?> zzr, Map<String, String> map) throws IOException, zza {
        ...
        BasicHttpResponse basicHttpResponse = new BasicHttpResponse(new BasicStatusLine(new ProtocolVersion("HTTP", 1, 1), zza.getStatusCode(), BuildConfig.FLAVOR));
        ArrayList arrayList = new ArrayList();
        for (zzl next : zza.zzr()) {
