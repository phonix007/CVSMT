...
public class zzach implements zzacd {
    ...
    public final void zza(View view, String str, @Nullable Bundle bundle, Map<String, WeakReference<View>> map, View view2, boolean z) {
        ...
        try {
            ...
            try {
                ...
                zza(view, zzp, zza, zzq, zzr, str, jSONObject, (JSONObject) null, z);
            }
            try {
            ...
            synchronized (map) {
                for (Map.Entry next : map.entrySet()) {
                    if (view.equals((View) ((WeakReference) next.getValue()).get())) {
                        zza(view, (String) next.getKey(), bundle, map, view2, false);
                        return;
                    }
                }
            }
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzaxz.m31e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        } else {
            zza((View) null, (JSONObject) null, (JSONObject) null, (JSONObject) null, (JSONObject) null, bundle.getBundle("click_signal").getString("asset_id"), (JSONObject) null, zzbv.zzlf().zza(bundle, (JSONObject) null), false);
        }
    }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzaxz.m31e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        } else {
    ...
    public final boolean recordImpression(Bundle bundle) {
        if (!zzbs("impression_reporting")) {
            zzaxz.m31e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
            return false;
        }
    ...
    public final void zzj(View view) {
        zzcq zzab;
        if (((Boolean) zzwu.zzpz().zzd(zzaan.zzctk)).booleanValue() && this.zzdcf != null && (zzab = this.zzdcf.zzab()) != null) {
            zzab.zzb(view);
        }
    }
    ...
    public zzbgg zzsp() throws zzbgq {
        ...
        zzbgg zza = zzbgm.zza(context, zzbht.zzb(zzg), zzg.zzckk, false, false, this.zzdcf, this.zzbob, (zzaba) null, (zzbo) null, (zzv) null, zzum.zzoi());
        if (zza != null) {
    ...
    public void recordCustomClickGesture() {
        if (this.zzdci == null) {
            ...
            zza(this.zzdci.zzsw(), "3099", (Bundle) null, this.zzdci.zzsv(), this.zzdci.zzsw(), true);
        }
    }
