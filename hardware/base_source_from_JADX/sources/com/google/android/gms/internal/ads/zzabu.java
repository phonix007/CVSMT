...
public final class zzabu extends zzadu implements zzacg {
    ...
    public final void performClick(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzdbj == null) {
                zzaxz.m31e("#001 Attempt to perform click before app native ad initialized.");
            } else {
    ...
    public final boolean recordImpression(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzdbj == null) {
                zzaxz.m31e("#002 Attempt to record impression before native ad initialized.");
                return false;
            }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzdbj == null) {
                zzaxz.m31e("#003 Attempt to report touch event before native ad initialized.");
            } else {
