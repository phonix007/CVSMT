...
public final class zzrg implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzrg(Context context, zzwf zzwf, zzaxf zzaxf, zzbbi zzbbi, zzsq zzsq) {
        ...
        this.zzbut = zzsq;
        this.zzbus = new WeakReference<>((Object) null);
        this.zzbvc = true;
        this.zzbve = false;
    ...
    public final void zzbu(int r8) {
        /*
            ...
            monitor-enter(r0)
            java.util.HashSet<com.google.android.gms.internal.ads.zzsb> r1 = r7.zzbvh     // Catch:{ all -> 0x00ce }
        ...
        L_0x0009:
            ...
            com.google.android.gms.internal.ads.zzsb r2 = (com.google.android.gms.internal.ads.zzsb) r2     // Catch:{ all -> 0x00ce }
            boolean r2 = r2.zznf()     // Catch:{ all -> 0x00ce }
        ...
        L_0x0020:
            ...
            boolean r1 = r7.zzbvc     // Catch:{ all -> 0x00ce }
            if (r1 != 0) goto L_0x0028
            goto L_0x00cc
        L_0x0028:
            com.google.android.gms.internal.ads.zzsq r1 = r7.zzbut     // Catch:{ all -> 0x00ce }
            android.view.View r1 = r1.zznc()     // Catch:{ all -> 0x00ce }
            if (r1 == 0) goto L_0x0040
            com.google.android.gms.internal.ads.zzayh r2 = com.google.android.gms.ads.internal.zzbv.zzlf()     // Catch:{ all -> 0x00ce }
            android.os.PowerManager r5 = r7.zzbuw     // Catch:{ all -> 0x00ce }
            android.app.KeyguardManager r6 = r7.zzbux     // Catch:{ all -> 0x00ce }
            boolean r2 = r2.zza((android.view.View) r1, (android.os.PowerManager) r5, (android.app.KeyguardManager) r6)     // Catch:{ all -> 0x00ce }
        ...
        L_0x0053:
            r5 = 0
        L_0x0054:
            com.google.android.gms.internal.ads.zzsq r6 = r7.zzbut     // Catch:{ all -> 0x00ce }
            boolean r6 = r6.zznd()     // Catch:{ all -> 0x00ce }
        ...
        L_0x0061:
            ...
            com.google.android.gms.internal.ads.zzbai r6 = r7.zzbua     // Catch:{ all -> 0x00ce }
            boolean r6 = r6.tryAcquire()     // Catch:{ all -> 0x00ce }
            if (r6 != 0) goto L_0x0071
            boolean r6 = r7.zzbve     // Catch:{ all -> 0x00ce }
        ...
        L_0x007b:
            ...
            org.json.JSONObject r8 = r7.zza((android.view.View) r1, (java.lang.Boolean) r8)     // Catch:{ RuntimeException | JSONException -> 0x0089 }
            r7.zza((org.json.JSONObject) r8, (boolean) r3)     // Catch:{ RuntimeException | JSONException -> 0x0089 }
            r7.zzbve = r5     // Catch:{ RuntimeException | JSONException -> 0x0089 }
            goto L_0x008f
        L_0x0089:
            r8 = move-exception
            java.lang.String r1 = "Active view update failed."
            com.google.android.gms.internal.ads.zzaxz.zza(r1, r8)     // Catch:{ all -> 0x00ce }
        L_0x008f:
            com.google.android.gms.internal.ads.zzsq r8 = r7.zzbut     // Catch:{ all -> 0x00ce }
            com.google.android.gms.internal.ads.zzsq r8 = r8.zzne()     // Catch:{ all -> 0x00ce }
            android.view.View r8 = r8.zznc()     // Catch:{ all -> 0x00ce }
            if (r8 == 0) goto L_0x00c7
            java.lang.ref.WeakReference<android.view.ViewTreeObserver> r1 = r7.zzbus     // Catch:{ all -> 0x00ce }
            ...
            boolean r2 = r7.zzbva     // Catch:{ all -> 0x00ce }
