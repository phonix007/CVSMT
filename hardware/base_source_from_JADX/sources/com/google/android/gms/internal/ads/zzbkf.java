...
class zzbkf implements zzbjt<zzbjm> {
    ...
    public final zzbsl zzb(zzbsl zzbsl) throws GeneralSecurityException {
        if (zzbsl instanceof zzbld) {
            ...
            return (zzbrd) zzblb.zzafz().zzb((zzblf) zzbkb.zza("type.googleapis.com/google.crypto.tink.AesCtrKey", (zzbsl) zzbld.zzagb())).zzb((zzbmp) zzbkb.zza("type.googleapis.com/google.crypto.tink.HmacKey", (zzbsl) zzbld.zzagc())).zzdk(0).zzana();
        }
