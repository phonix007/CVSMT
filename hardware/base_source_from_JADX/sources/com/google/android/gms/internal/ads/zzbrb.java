...
abstract class zzbrb<T extends zzbqq> {
    ...
    static <T extends zzbqq> T zza(Class<T> cls) {
        ...
        try {
            ...
            Iterator<S> it = ServiceLoader.load(zzbrb.class, classLoader).iterator();
            ...
            try {
                return (zzbqq) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
