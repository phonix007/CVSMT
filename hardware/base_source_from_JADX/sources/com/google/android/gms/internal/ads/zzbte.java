...
final class zzbte {
    ...
    static int zzaf(List<Long> list) {
        ...
        if (list instanceof zzbrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzbb(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzag(List<Long> list) {
        ...
        if (list instanceof zzbrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzbc(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzah(List<Long> list) {
        ...
        if (list instanceof zzbrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzbd(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzai(List<Integer> list) {
        ...
        if (list instanceof zzbre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzfj(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzaj(List<Integer> list) {
        ...
        if (list instanceof zzbre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzfe(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzak(List<Integer> list) {
        ...
        if (list instanceof zzbre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzff(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzal(List<Integer> list) {
        ...
        if (list instanceof zzbre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzbqk.zzfg(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
