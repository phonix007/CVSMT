...
public abstract class zzve extends zzum {
    ...
    public static final boolean zzbvq = zzys.zzyv();
    zzvg zzbvr;
    ...
    static final class zze extends zzve {
        ...
        public final void zzc(byte b) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzbwa), Long.valueOf(this.zzbvy), 1}));
        }
        ...
        public final void zzaz(int i) throws IOException {
            if (!zzve.zzbvq || zzvq() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zzys.zza(bArr3, (long) i4, (byte) ((i & 127) | 128));
                    i >>>= 7;
                }
        ...
        public final void zzay(long j) throws IOException {
            if (!zzve.zzbvq || zzvq() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzys.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    public final void zza(String str, zzyy zzyy) throws IOException {
        logger.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzyy);
