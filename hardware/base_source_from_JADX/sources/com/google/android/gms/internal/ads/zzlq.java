...
final class zzlq {
    ...
    public final long zzaq(int i) {
        ...
        if (zzfk != 0) {
            ...
            for (int i2 = this.length - 1; i2 >= 0; i2--) {
                int i3 = (this.zzaye + i2) % this.zzaxz;
                this.zzayh = Math.max(this.zzayh, this.zzagw[i3]);
                if ((this.zzapr[i3] & 1) != 0) {
                    break;
                }
            }
            ...
            int i4 = (this.zzayf == 0 ? this.zzaxz : this.zzayf) - 1;
            return this.zzagu[i4] + ((long) this.zzagt[i4]);
        }
    }
    ...
    public final synchronized void zza(long r6, int r8, long r9, int r11, com.google.android.gms.internal.ads.zzij r12) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.zzayi     // Catch:{ all -> 0x00e9 }
            r1 = 0
        ...
        L_0x000e:
            boolean r0 = r5.zzayj     // Catch:{ all -> 0x00e9 }
            r0 = r0 ^ 1
            com.google.android.gms.internal.ads.zzpo.checkState(r0)     // Catch:{ all -> 0x00e9 }
            r5.zzac(r6)     // Catch:{ all -> 0x00e9 }
            long[] r0 = r5.zzagw     // Catch:{ all -> 0x00e9 }
            int r2 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            r0[r2] = r6     // Catch:{ all -> 0x00e9 }
            long[] r6 = r5.zzagu     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            r6[r7] = r9     // Catch:{ all -> 0x00e9 }
            int[] r6 = r5.zzagt     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            r6[r7] = r11     // Catch:{ all -> 0x00e9 }
            int[] r6 = r5.zzapr     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            r6[r7] = r8     // Catch:{ all -> 0x00e9 }
            com.google.android.gms.internal.ads.zzij[] r6 = r5.zzayb     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            r6[r7] = r12     // Catch:{ all -> 0x00e9 }
            com.google.android.gms.internal.ads.zzfs[] r6 = r5.zzayc     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            com.google.android.gms.internal.ads.zzfs r8 = r5.zzayk     // Catch:{ all -> 0x00e9 }
            r6[r7] = r8     // Catch:{ all -> 0x00e9 }
            int[] r6 = r5.zzaya     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            ...
            int r6 = r5.length     // Catch:{ all -> 0x00e9 }
            int r7 = r5.zzaxz     // Catch:{ all -> 0x00e9 }
            if (r6 != r7) goto L_0x00d9
            int r6 = r5.zzaxz     // Catch:{ all -> 0x00e9 }
            int r6 = r6 + 1000
            ...
            return
        L_0x00d9:
            int r6 = r5.zzayf     // Catch:{ all -> 0x00e9 }
            int r6 = r6 + 1
