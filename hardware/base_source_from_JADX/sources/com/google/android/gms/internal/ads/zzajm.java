...
public final class zzajm extends zzbcr<zzaii> {
    ...
    public final void zzue() {
        synchronized (this.mLock) {
            Preconditions.checkState(this.zzdjt > 0);
            zzaxz.m30v("Releasing 1 reference for JS Engine");
            this.zzdjt--;
            zzug();
        }
    }
    ...
    public final void zzuf() {
        synchronized (this.mLock) {
            Preconditions.checkState(this.zzdjt >= 0);
            zzaxz.m30v("Releasing root reference. JS Engine will be destroyed once other references are released.");
            this.zzdjs = true;
            zzug();
        }
    }
    ...
    private final void zzug() {
        synchronized (this.mLock) {
            ...
            if (!this.zzdjs || this.zzdjt != 0) {
                zzaxz.m30v("There are still references to the engine. Not destroying.");
            } else {
                zzaxz.m30v("No reference is left (including root). Cleaning up engine.");
