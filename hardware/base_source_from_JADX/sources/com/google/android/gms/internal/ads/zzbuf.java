        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                ...
                if (zzbud.zze(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzbud.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        r13 = i8 + 1;
                        i5++;
                    } else {
                        throw zzbrl.zzank();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzbud.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    r13 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzbrl.zzank();
