...
public class zzaf {
    ...
    static class zza {
        ...
        public final synchronized void zzc(String str) {
            ...
            if (j > 0) {
                ...
                zzaf.m27d("(%-4d ms) %s", Long.valueOf(j), str);
                for (zzag next : this.zzbl) {
                    long j3 = next.time;
                    zzaf.m27d("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(next.zzbn), next.name);
                    j2 = j3;
                }
            }
        }
        ...
        public final void finalize() throws Throwable {
            if (!this.zzbm) {
                ...
                zzaf.m28e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    }
    ...
    /* renamed from: e */
    public static void m28e(String str, Object... objArr) {
