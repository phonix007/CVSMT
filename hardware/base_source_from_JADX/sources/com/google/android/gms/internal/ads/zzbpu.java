...
public abstract class zzbpu implements Serializable, Iterable<Byte> {
    ...
    private static final zzbpz zzflj = (zzbpp.zzakl() ? new zzbqe((zzbpv) null) : new zzbpx((zzbpv) null));
    ...
    public final String zzakn() {
        return size() == 0 ? BuildConfig.FLAVOR : zza(zzbrf.UTF_8);
    }
