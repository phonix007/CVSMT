...
public final class zzx extends zzh implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public final boolean zza(@android.support.annotation.Nullable com.google.android.gms.internal.ads.zzaxf r5, com.google.android.gms.internal.ads.zzaxf r6) {
        ...
        L_0x0008:
            ...
            r5.zza((com.google.android.gms.internal.ads.zzuo.zza.zzb) r6)
        L_0x0021:
            r4.zzbr(r1)
            return r1
        L_0x0025:
            ...
            com.google.android.gms.internal.ads.zzbct.zza((android.view.View) r5, (android.view.ViewTreeObserver.OnGlobalLayoutListener) r4)
            com.google.android.gms.ads.internal.zzbv.zzme()
            com.google.android.gms.ads.internal.zzbw r5 = r4.zzbls
            com.google.android.gms.ads.internal.zzbx r5 = r5.zzbsq
            com.google.android.gms.internal.ads.zzbct.zza((android.view.View) r5, (android.view.ViewTreeObserver.OnScrollChangedListener) r4)
            boolean r5 = r6.zzehi
        ...
        L_0x0059:
            ...
            r2.<init>(r6, r5)
            r1.zza((com.google.android.gms.internal.ads.zzbhr) r2)
            goto L_0x0081
        L_0x0064:
            com.google.android.gms.ads.internal.zzbw r5 = r4.zzbls
            boolean r5 = r5.zzmk()
            ...
            if (r5 == 0) goto L_0x0081
        L_0x007e:
            r4.zza((com.google.android.gms.internal.ads.zzaxf) r6, (boolean) r1)
        L_0x0081:
        ...
        L_0x00c4:
            ...
            r1.<init>(r2, r3)
            r5.zza((com.google.android.gms.internal.ads.zzsg) r1)
        L_0x0103:
            boolean r1 = r6.zzmu()
        ...
        L_0x010f:
            ...
            r2.<init>(r5, r6)
            r1.zza((com.google.android.gms.internal.ads.zzbhq) r2)
            goto L_0x0139
        L_0x011e:
            com.google.android.gms.ads.internal.zzbw r5 = r4.zzbls
    ...
    private final void zzc(zzbgg zzbgg) {
        ...
        if (zzjj() && (webView = zzbgg.getWebView()) != null && (view = zzbgg.getView()) != null && zzbv.zzlw().zzk(this.zzbls.zzsp)) {
            ...
            sb.append(".");
            sb.append(i2);
            this.zzblx = zzbv.zzlw().zza(sb.toString(), webView, BuildConfig.FLAVOR, "javascript", zzit());
            if (this.zzblx != null) {
    ...
    public final void zza(@Nullable zzaxf zzaxf, boolean z) {
        if (zzjj()) {
            ...
            if (zzbgg != null) {
                ...
                if (this.zzblx != null) {
                    zzbgg.zza("onSdkImpression", (Map<String, ?>) new ArrayMap());
                }
            }
        }
        super.zza(zzaxf, z);
                    ...
                    if (list != null) {
                        if (!list.isEmpty()) {
                            ...
                            if (list.contains("2") && zzuu != null) {
                                ...
                                zzbgg2.zza("/nativeExpressViewClicked", (zzu<? super zzbgg>) zzas.zza(zzuu, (zzalv) null, zzab));
                                return;
                                ...
                                zzbgg2.zza("/nativeExpressViewClicked", (zzu<? super zzbgg>) zzas.zza((zzals) null, zzuv, zzab));
                                return;
                            }
                        }
                    }
    ...
    public final void zzd(@Nullable zzaxf zzaxf) {
        if (zzaxf != null && !zzaxf.zzehi && this.zzbls.zzbsq != null && zzbv.zzlf().zza((View) this.zzbls.zzbsq, this.zzbls.zzsp) && this.zzbls.zzbsq.getGlobalVisibleRect(new Rect(), (Point) null)) {
