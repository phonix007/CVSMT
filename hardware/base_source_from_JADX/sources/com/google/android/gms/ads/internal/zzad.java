...
public final class zzad {
    ...
    public final void zza(Context context, zzbbi zzbbi, String str, @Nullable Runnable runnable) {
        zza(context, zzbbi, true, (zzaxj) null, str, (String) null, runnable);
    }
    ...
    public final void zza(Context context, zzbbi zzbbi, boolean z, @Nullable zzaxj zzaxj, String str, @Nullable String str2, @Nullable Runnable runnable) {
        ...
        if (z2) {
            if (context == null) {
                ...
                zzajv<I, O> zza = zzbv.zzlu().zzb(this.mContext, zzbbi).zza("google.afma.config.fetchAppSettings", zzaka.zzdkb, zzaka.zzdkb);
                try {
                    ...
                    zzbcb<O> zzj = zza.zzj(jSONObject);
                    zzbcb<B> zza2 = zzbbq.zza(zzj, zzae.zzbni, zzbcg.zzepp);
                    if (runnable != null) {
