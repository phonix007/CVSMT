...
public class HttpClient implements zzu<zzahu> {
    ...
    private static zzb zzc(JSONObject jSONObject) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                arrayList.add(new zza(optJSONObject.optString("key"), optJSONObject.optString(AppMeasurementSdk.ConditionalUserProperty.VALUE)));
            }
        }
    ...
    private static JSONObject zza(zzd zzd2) {
        ...
        try {
            ...
            for (zza next : zzd2.zztd()) {
                jSONArray.put(new JSONObject().put("key", next.getKey()).put(AppMeasurementSdk.ConditionalUserProperty.VALUE, next.getValue()));
            }
    ...
    private final com.google.android.gms.ads.internal.gmsg.HttpClient.zzc zza(com.google.android.gms.ads.internal.gmsg.HttpClient.zzb r13) {
        ...
        L_0x00b5:
            ...
            java.lang.String r8 = com.google.android.gms.internal.ads.zzayh.zza((java.io.InputStreamReader) r8)     // Catch:{ Exception -> 0x00eb }
