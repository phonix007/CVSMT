...
public final class zzay extends zzyd {
    ...
    public final void zzb(IObjectWrapper iObjectWrapper, String str) {
        if (iObjectWrapper == null) {
            zzaxz.m31e("Wrapped context is null. Failed to open debug menu.");
            return;
        }
        Context context = (Context) ObjectWrapper.unwrap(iObjectWrapper);
        if (context == null) {
            zzaxz.m31e("Context is null. Failed to open debug menu.");
            return;
        }
        ...
        if (zzyg != null && !zzyg.isEmpty()) {
            ...
            if (zzxg != null) {
                ...
                for (Map.Entry entry : hashMap.entrySet()) {
                    ...
                    try {
                        zzavy zzdd = zzxg.zzdd(str2);
                        if (zzdd != null) {
                            zzalj zzxn = zzdd.zzxn();
                            if (!zzxn.isInitialized()) {
                                if (zzxn.zzuy()) {
                                    zzxn.zza(wrap, (zzavz) zzdd.zzxo(), (List<String>) (List) entry.getValue());
