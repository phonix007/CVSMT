...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, OnImmersiveModeUpdatedListener, com.google.android.gms.ads.mediation.zzb, MediationRewardedVideoAdAdapter, zzbiy {
    ...
    public void requestNativeAd(Context context, MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        ...
        if (nativeMediationAdRequest.zzvg()) {
            for (String next : nativeMediationAdRequest.zzvh().keySet()) {
                withAdListener.forCustomTemplateAd(next, zzf2, nativeMediationAdRequest.zzvh().get(next).booleanValue() ? zzf2 : null);
            }
        }
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle2) {
        if (this.zzhv == null || this.zzhx == null) {
            zzbbd.m31e("AdMobAdapter.loadAd called before initialize.");
            return;
        }
