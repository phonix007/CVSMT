...
import android.support.mediacompat.C0073R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0073R.C0075id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0073R.C0075id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0073R.C0075id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0073R.C0075id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0073R.C0075id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0073R.C0075id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0073R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0073R.C0075id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0073R.C0075id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0073R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0073R.C0075id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0073R.C0075id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0073R.C0075id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0073R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0073R.C0075id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0073R.C0075id.cancel_action, 0);
        ...
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0073R.layout.notification_template_big_media_narrow : C0073R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0073R.layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0073R.layout.notification_template_big_media_narrow_custom : C0073R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0073R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0073R.C0075id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }
}
