...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    @Nullable
    String mName;
    ArrayList<C0097Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0097Op {
        ...
        C0097Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0097Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0097Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0097Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0097Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0097Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0097Op(8, fragment));
        return this;
    }
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0097Op op2 = backStackRecord.mOps.get(i7);
            ...
            switch (op.cmd) {
                        ...
                        if (fragment5.mContainerId == i2) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i3, new C0097Op(9, fragment5));
                                    i3++;
                                    fragment4 = null;
                                }
                                C0097Op op2 = new C0097Op(3, fragment5);
                ...
                case 6:
                    ...
                    if (op.fragment != fragment2) {
                        ...
                        this.mOps.add(i, new C0097Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                        break;
                    }
                case 8:
                    this.mOps.add(i, new C0097Op(9, fragment2));
                    i++;
    ...
    private static boolean isFragmentPostponed(C0097Op op) {
        Fragment fragment = op.fragment;
