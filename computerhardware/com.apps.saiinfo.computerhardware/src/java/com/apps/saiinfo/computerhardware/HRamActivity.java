...
import com.apps.saiinfo.computerhardware.HRamInActivity;
import com.apps.saiinfo.computerhardware.HRamsActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HRamActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296322);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HRamActivity.this, HRamsActivity.class);
                HRamActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HRamActivity.this, HRamInActivity.class);
                HRamActivity.this.startActivity(intent);
            }
        });
