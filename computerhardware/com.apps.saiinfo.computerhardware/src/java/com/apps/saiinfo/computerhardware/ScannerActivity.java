...
import com.apps.saiinfo.computerhardware.ScanActivity;
import com.apps.saiinfo.computerhardware.ScanInActivity;
import com.apps.saiinfo.computerhardware.ScanUseActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296392);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)ScannerActivity.this, ScanUseActivity.class);
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)ScannerActivity.this, ScanInActivity.class);
                ScannerActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)ScannerActivity.this, ScanActivity.class);
                ScannerActivity.this.startActivity(intent);
            }
        });
