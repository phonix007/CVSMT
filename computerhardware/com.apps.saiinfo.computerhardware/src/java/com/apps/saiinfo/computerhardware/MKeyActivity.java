...
import com.apps.saiinfo.computerhardware.MFunActivity;
import com.apps.saiinfo.computerhardware.MKeyConnetActivity;
import com.apps.saiinfo.computerhardware.MKeyNameActivity;
import com.apps.saiinfo.computerhardware.MKeysActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MKeyActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MKeyActivity.this, MKeyNameActivity.class);
                MKeyActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MKeyActivity.this, MFunActivity.class);
                MKeyActivity.this.startActivity(intent);
            }
        });
        ...
        this.four.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MKeyActivity.this, MKeyConnetActivity.class);
                MKeyActivity.this.startActivity(intent);
            }
        });
        ...
        this.five.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MKeyActivity.this, AppsActivity.class);
                MKeyActivity.this.startActivity(intent);
            }
        });
