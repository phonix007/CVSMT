...
import com.apps.saiinfo.computerhardware.MDiskActivity;
import com.apps.saiinfo.computerhardware.MHDActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MHardActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296345);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MHardActivity.this, MDiskActivity.class);
                MHardActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MHardActivity.this, MHDActivity.class);
                MHardActivity.this.startActivity(intent);
            }
        });
