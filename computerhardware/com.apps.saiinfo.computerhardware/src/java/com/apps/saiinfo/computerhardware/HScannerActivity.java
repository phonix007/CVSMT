...
import com.apps.saiinfo.computerhardware.HScanActivity;
import com.apps.saiinfo.computerhardware.HScanInActivity;
import com.apps.saiinfo.computerhardware.HScanUseActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HScannerActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296328);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HScannerActivity.this, HScanUseActivity.class);
                HScannerActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HScannerActivity.this, HScanInActivity.class);
                HScannerActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HScannerActivity.this, HScanActivity.class);
                HScannerActivity.this.startActivity(intent);
            }
        });
