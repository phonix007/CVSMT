...
import com.apps.saiinfo.computerhardware.MPrintActivity;
import com.apps.saiinfo.computerhardware.MPrintInActivity;
import com.apps.saiinfo.computerhardware.MPrintsActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MPrinterActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296369);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MPrinterActivity.this, MPrintsActivity.class);
                MPrinterActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MPrinterActivity.this, MPrintInActivity.class);
                MPrinterActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MPrinterActivity.this, MPrintActivity.class);
                MPrinterActivity.this.startActivity(intent);
            }
        });
