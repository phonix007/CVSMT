...
import com.apps.saiinfo.computerhardware.HMonActivity;
import com.apps.saiinfo.computerhardware.HMonConnectActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HMonitorActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296313);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HMonitorActivity.this, HMonActivity.class);
                HMonitorActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMonitorActivity.this, HMonConnectActivity.class);
                HMonitorActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMonitorActivity.this, AppsActivity.class);
                HMonitorActivity.this.startActivity(intent);
            }
        });
