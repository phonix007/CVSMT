...
import com.apps.saiinfo.computerhardware.PrintActivity;
import com.apps.saiinfo.computerhardware.PrintInActivity;
import com.apps.saiinfo.computerhardware.PrintsActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296384);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)PrinterActivity.this, PrintsActivity.class);
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)PrinterActivity.this, PrintInActivity.class);
                PrinterActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)PrinterActivity.this, PrintActivity.class);
                PrinterActivity.this.startActivity(intent);
            }
        });
