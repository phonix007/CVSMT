...
import com.apps.saiinfo.computerhardware.HBoardActivity;
import com.apps.saiinfo.computerhardware.HPartsActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HMotherActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296314);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HMotherActivity.this, HBoardActivity.class);
                HMotherActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMotherActivity.this, HPartsActivity.class);
                HMotherActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMotherActivity.this, AppsActivity.class);
                HMotherActivity.this.startActivity(intent);
            }
        });
