...
import com.apps.saiinfo.computerhardware.MonActivity;
import com.apps.saiinfo.computerhardware.MonConnectActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MonitorActivity.this, MonConnectActivity.class);
                MonitorActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MonitorActivity.this, AppsActivity.class);
                MonitorActivity.this.startActivity(intent);
            }
        });
