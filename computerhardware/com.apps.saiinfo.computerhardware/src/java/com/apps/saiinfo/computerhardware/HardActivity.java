...
import com.apps.saiinfo.computerhardware.DiskActivity;
import com.apps.saiinfo.computerhardware.HDActivity;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.one.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HardActivity.this, DiskActivity.class);
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HardActivity.this, HDActivity.class);
                HardActivity.this.startActivity(intent);
            }
        });
