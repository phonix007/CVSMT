...
import com.apps.saiinfo.computerhardware.HDiskActivity;
import com.apps.saiinfo.computerhardware.HHDActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HHardActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296301);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HHardActivity.this, HDiskActivity.class);
                HHardActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HHardActivity.this, HHDActivity.class);
                HHardActivity.this.startActivity(intent);
            }
        });
