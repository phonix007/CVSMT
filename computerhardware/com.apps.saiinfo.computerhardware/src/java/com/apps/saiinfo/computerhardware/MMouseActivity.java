...
import com.apps.saiinfo.computerhardware.MConnectActivity;
import com.apps.saiinfo.computerhardware.MMActivity;
import com.apps.saiinfo.computerhardware.MTypesActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MMouseActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296359);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MMouseActivity.this, MMActivity.class);
                MMouseActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MMouseActivity.this, MTypesActivity.class);
                MMouseActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MMouseActivity.this, MConnectActivity.class);
                MMouseActivity.this.startActivity(intent);
            }
        });
