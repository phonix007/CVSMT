...
import com.apps.saiinfo.computerhardware.HConnectActivity;
import com.apps.saiinfo.computerhardware.HMActivity;
import com.apps.saiinfo.computerhardware.HTypesActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HMouseActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296315);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)HMouseActivity.this, HMActivity.class);
                HMouseActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMouseActivity.this, HTypesActivity.class);
                HMouseActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)HMouseActivity.this, HConnectActivity.class);
                HMouseActivity.this.startActivity(intent);
            }
        });
