...
import com.apps.saiinfo.computerhardware.MScanActivity;
import com.apps.saiinfo.computerhardware.MScanInActivity;
import com.apps.saiinfo.computerhardware.MScanUseActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MScannerActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296377);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MScannerActivity.this, MScanUseActivity.class);
                MScannerActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MScannerActivity.this, MScanInActivity.class);
                MScannerActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MScannerActivity.this, MScanActivity.class);
                MScannerActivity.this.startActivity(intent);
            }
        });
