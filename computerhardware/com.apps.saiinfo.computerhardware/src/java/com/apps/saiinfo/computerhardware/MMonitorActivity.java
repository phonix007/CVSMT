...
import com.apps.saiinfo.computerhardware.MMonActivity;
import com.apps.saiinfo.computerhardware.MMonConnectActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MMonitorActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296357);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MMonitorActivity.this, MMonActivity.class);
                MMonitorActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MMonitorActivity.this, MMonConnectActivity.class);
                MMonitorActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MMonitorActivity.this, AppsActivity.class);
                MMonitorActivity.this.startActivity(intent);
            }
        });
