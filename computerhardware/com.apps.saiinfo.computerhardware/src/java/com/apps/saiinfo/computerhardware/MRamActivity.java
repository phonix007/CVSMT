...
import com.apps.saiinfo.computerhardware.MRamInActivity;
import com.apps.saiinfo.computerhardware.MRamsActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class MRamActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2131296371);
        this.one = (CardView)this.findViewById(2131165422);
        this.one.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)MRamActivity.this, MRamsActivity.class);
                MRamActivity.this.startActivity(intent);
            }
        });
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MRamActivity.this, MRamInActivity.class);
                MRamActivity.this.startActivity(intent);
            }
        });
