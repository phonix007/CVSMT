...
import com.apps.saiinfo.computerhardware.RamInActivity;
import com.apps.saiinfo.computerhardware.RamsActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)RamActivity.this, RamInActivity.class);
                RamActivity.this.startActivity(intent);
            }
        });
