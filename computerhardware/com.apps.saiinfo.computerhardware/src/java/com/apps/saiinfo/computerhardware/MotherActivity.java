...
import com.apps.saiinfo.computerhardware.BoardActivity;
import com.apps.saiinfo.computerhardware.PartsActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.two.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MotherActivity.this, PartsActivity.class);
                MotherActivity.this.startActivity(intent);
            }
        });
        ...
        this.three.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)MotherActivity.this, AppsActivity.class);
                MotherActivity.this.startActivity(intent);
            }
        });
