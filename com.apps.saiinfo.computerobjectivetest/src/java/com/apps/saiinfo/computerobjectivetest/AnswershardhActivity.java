...
import com.apps.saiinfo.computerobjectivetest.AnswershardhActivity;
...
public class AnswershardhActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databacehardh((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionshardh)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswershardhActivity.this.originalValues.get(n)).get((Object)AnswershardhActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("\u0938\u0939\u0940 \u091c\u0935\u093e\u092c: " + ((HashMap)AnswershardhActivity.this.originalValues.get(n)).get((Object)AnswershardhActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("\u0906\u092a\u0915\u093e \u091c\u0935\u093e\u092c: " + ((HashMap)AnswershardhActivity.this.originalValues.get(n)).get((Object)AnswershardhActivity.KEY_YANS).toString()));
                return view;
            }
