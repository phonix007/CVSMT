...
import com.apps.saiinfo.computerobjectivetest.AnswerssystemActivity;
...
public class AnswerssystemActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968661);
        ...
        this.questionsList = new Databacesystem((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssystem)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssystemActivity.this.originalValues.get(n)).get((Object)AnswerssystemActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerssystemActivity.this.originalValues.get(n)).get((Object)AnswerssystemActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerssystemActivity.this.originalValues.get(n)).get((Object)AnswerssystemActivity.KEY_YANS).toString()));
                return view;
            }
