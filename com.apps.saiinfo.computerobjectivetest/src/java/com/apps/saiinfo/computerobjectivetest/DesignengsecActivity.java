...
import com.apps.saiinfo.computerobjectivetest.data.Databaceengsec;
...
public class DesignengsecActivity
extends AppCompatActivity {
    ArrayList<String> AnsList;
    private TextView TotalQues;
    private int answeredQsNo = 0;
    private Button btnSubmit;
    private Questionsengsec currentQuestion;
    ImageButton hard;
    private int obtainedScore = 0;
    ImageButton pen;
    ImageButton pri;
    private int questionId = 0;
    private List<Questionsengsec> questionsList;
    ...
    static /* synthetic */ Questionsengsec access$000(DesignengsecActivity designengsecActivity) {
        return designengsecActivity.currentQuestion;
    }

    static /* synthetic */ Questionsengsec access$002(DesignengsecActivity designengsecActivity, Questionsengsec questionsengsec) {
        designengsecActivity.currentQuestion = questionsengsec;
        return questionsengsec;
    }

    static /* synthetic */ int access$100(DesignengsecActivity designengsecActivity) {
        return designengsecActivity.obtainedScore;
    }

    static /* synthetic */ int access$108(DesignengsecActivity designengsecActivity) {
        int n = designengsecActivity.obtainedScore;
        designengsecActivity.obtainedScore = n + 1;
        return n;
    }

    static /* synthetic */ int access$200(DesignengsecActivity designengsecActivity) {
        return designengsecActivity.questionId;
    }

    static /* synthetic */ List access$300(DesignengsecActivity designengsecActivity) {
        return designengsecActivity.questionsList;
    }

    static /* synthetic */ void access$400(DesignengsecActivity designengsecActivity) {
        designengsecActivity.setQuestionsView();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.pen.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ DesignengsecActivity this$0;
            {
                this.this$0 = designengsecActivity;
            }
        ...
        this.init();
        Databaceengsec databaceengsec = new Databaceengsec((Context)this);
        this.questionsList = databaceengsec.getAllQuestions();
        this.currentQuestion = (Questionsengsec)this.questionsList.get(this.questionId);
        this.setQuestionsView();
        this.btnSubmit.setOnClickListener(new View.OnClickListener(this, databaceengsec){
            final /* synthetic */ DesignengsecActivity this$0;
            final /* synthetic */ Databaceengsec val$databaceengsec;
            {
                this.this$0 = designengsecActivity;
                this.val$databaceengsec = databaceengsec;
            }
            ...
            public void onClick(View view) {
                ...
                if (radioButton != null) {
                    android.util.Log.e((String)"Answer", (String)(DesignengsecActivity.access$000(this.this$0).getANSWER() + " -- " + (Object)radioButton.getText()));
                    this.this$0.AnsList.add((Object)("" + (Object)radioButton.getText()));
                    if (DesignengsecActivity.access$000(this.this$0).getANSWER().equals((Object)radioButton.getText())) {
                        DesignengsecActivity.access$108(this.this$0);
                        android.util.Log.e((String)"comments", (String)"Correct Answer");
                        android.util.Log.d((String)"score", (String)("Obtained score " + DesignengsecActivity.access$100(this.this$0)));
                    } else {
                        android.util.Log.e((String)"comments", (String)"Wrong Answer");
                    }
                    if (DesignengsecActivity.access$200(this.this$0) < this.val$databaceengsec.rowCount()) {
                        DesignengsecActivity.access$002(this.this$0, (Questionsengsec)DesignengsecActivity.access$300(this.this$0).get(DesignengsecActivity.access$200(this.this$0)));
                        DesignengsecActivity.access$400(this.this$0);
                    } else {
                        android.content.Intent intent = new android.content.Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.ResultengsecActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("score", DesignengsecActivity.access$100(this.this$0));
                        bundle.putInt("totalQs", DesignengsecActivity.access$300(this.this$0).size());
