...
import com.apps.saiinfo.computerobjectivetest.AnswerssengActivity;
...
public class AnswerssengActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968652);
        ...
        this.questionsList = new Databaceseng((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsseng)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssengActivity.this.originalValues.get(n)).get((Object)AnswerssengActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerssengActivity.this.originalValues.get(n)).get((Object)AnswerssengActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerssengActivity.this.originalValues.get(n)).get((Object)AnswerssengActivity.KEY_YANS).toString()));
                return view;
            }
