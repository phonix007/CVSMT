...
import com.apps.saiinfo.computerobjectivetest.AnswerseallActivity;
...
public class AnswerseallActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceeall((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionseall)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerseallActivity.this.originalValues.get(n)).get((Object)AnswerseallActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerseallActivity.this.originalValues.get(n)).get((Object)AnswerseallActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerseallActivity.this.originalValues.get(n)).get((Object)AnswerseallActivity.KEY_YANS).toString()));
                return view;
            }
