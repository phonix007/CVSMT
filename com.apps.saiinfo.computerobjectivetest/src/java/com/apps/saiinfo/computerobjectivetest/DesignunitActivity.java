...
import com.apps.saiinfo.computerobjectivetest.DesignunitActivity;
import com.apps.saiinfo.computerobjectivetest.data.Databaceunit;
...
public class DesignunitActivity
extends AppCompatActivity {
    ...
    private Questionsunit currentQuestion;
    private int obtainedScore = 0;
    ImageButton pc;
    private int questionId = 0;
    private List<Questionsunit> questionsList;
    ...
    static /* synthetic */ Questionsunit access$000(DesignunitActivity designunitActivity) {
        return designunitActivity.currentQuestion;
    }

    static /* synthetic */ Questionsunit access$002(DesignunitActivity designunitActivity, Questionsunit questionsunit) {
        designunitActivity.currentQuestion = questionsunit;
        return questionsunit;
    }

    static /* synthetic */ int access$100(DesignunitActivity designunitActivity) {
        return designunitActivity.obtainedScore;
    }

    static /* synthetic */ int access$108(DesignunitActivity designunitActivity) {
        int n = designunitActivity.obtainedScore;
        designunitActivity.obtainedScore = n + 1;
        return n;
    }

    static /* synthetic */ int access$200(DesignunitActivity designunitActivity) {
        return designunitActivity.questionId;
    }

    static /* synthetic */ List access$300(DesignunitActivity designunitActivity) {
        return designunitActivity.questionsList;
    }

    static /* synthetic */ void access$400(DesignunitActivity designunitActivity) {
        designunitActivity.setQuestionsView();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.init();
        Databaceunit databaceunit = new Databaceunit((Context)this);
        this.questionsList = databaceunit.getAllQuestions();
        this.currentQuestion = (Questionsunit)this.questionsList.get(this.questionId);
        this.setQuestionsView();
        this.btnSubmit.setOnClickListener(new View.OnClickListener(this, databaceunit){
            final /* synthetic */ DesignunitActivity this$0;
            final /* synthetic */ Databaceunit val$databace;
            {
                this.this$0 = designunitActivity;
                this.val$databace = databaceunit;
            }
            ...
            public void onClick(View view) {
                ...
                if (radioButton != null) {
                    android.util.Log.e((String)"Answer", (String)(DesignunitActivity.access$000(this.this$0).getANSWER() + " -- " + (Object)radioButton.getText()));
                    this.this$0.AnsList.add((Object)("" + (Object)radioButton.getText()));
                    if (DesignunitActivity.access$000(this.this$0).getANSWER().equals((Object)radioButton.getText())) {
                        DesignunitActivity.access$108(this.this$0);
                        android.util.Log.e((String)"comments", (String)"Correct Answer");
                        android.util.Log.d((String)"score", (String)("Obtained score " + DesignunitActivity.access$100(this.this$0)));
                    } else {
                        android.util.Log.e((String)"comments", (String)"Wrong Answer");
                    }
                    if (DesignunitActivity.access$200(this.this$0) < this.val$databace.rowCount()) {
                        DesignunitActivity.access$002(this.this$0, (Questionsunit)DesignunitActivity.access$300(this.this$0).get(DesignunitActivity.access$200(this.this$0)));
                        DesignunitActivity.access$400(this.this$0);
                    } else {
                        android.content.Intent intent = new android.content.Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.ResultunitActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("score", DesignunitActivity.access$100(this.this$0));
                        bundle.putInt("totalQs", DesignunitActivity.access$300(this.this$0).size());
