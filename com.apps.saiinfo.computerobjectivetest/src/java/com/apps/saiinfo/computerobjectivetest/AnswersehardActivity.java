...
import com.apps.saiinfo.computerobjectivetest.AnswersehardActivity;
...
public class AnswersehardActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceehard((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsehard)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersehardActivity.this.originalValues.get(n)).get((Object)AnswersehardActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersehardActivity.this.originalValues.get(n)).get((Object)AnswersehardActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersehardActivity.this.originalValues.get(n)).get((Object)AnswersehardActivity.KEY_YANS).toString()));
                return view;
            }
