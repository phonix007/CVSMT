...
import com.apps.saiinfo.computerobjectivetest.AnswersmallActivity;
...
public class AnswersmallActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databacemall((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsmall)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersmallActivity.this.originalValues.get(n)).get((Object)AnswersmallActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("\u092c\u0930\u094b\u092c\u0930 \u0909\u0924\u094d\u0924\u0930: " + ((HashMap)AnswersmallActivity.this.originalValues.get(n)).get((Object)AnswersmallActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("\u0924\u0941\u092e\u091a\u0902 \u0909\u0924\u094d\u0924\u0930: " + ((HashMap)AnswersmallActivity.this.originalValues.get(n)).get((Object)AnswersmallActivity.KEY_YANS).toString()));
                return view;
            }
