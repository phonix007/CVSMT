    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.test1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)systemActivity.this, DesignsysActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)systemActivity.this, DesignunitActivity.class);
                systemActivity.this.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)systemActivity.this, DesignsystemActivity.class);
                systemActivity.this.startActivity(intent);
            }
        });
    }
