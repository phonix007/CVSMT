...
import com.apps.saiinfo.computerobjectivetest.ResultinterhActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;
import java.util.ArrayList;

public class ResultinterhActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((Button)this.findViewById(2131558598)).setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ ResultinterhActivity this$0;
            {
                this.this$0 = resultinterhActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((android.content.Context)this.this$0, com.apps.saiinfo.computerobjectivetest.AnswersinterhActivity.class);
