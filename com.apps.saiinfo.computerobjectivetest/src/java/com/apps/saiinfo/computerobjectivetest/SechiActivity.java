...
import com.apps.saiinfo.computerobjectivetest.SechiActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class SechiActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968792);
        ...
        this.test1.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ SechiActivity this$0;
            {
                this.this$0 = sechiActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignshActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignsechindiActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignsechiActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
