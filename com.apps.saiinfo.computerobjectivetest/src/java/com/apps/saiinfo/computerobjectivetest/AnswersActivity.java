...
import com.apps.saiinfo.computerobjectivetest.AnswersActivity;
...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databace((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questions)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersActivity.this.originalValues.get(n)).get((Object)AnswersActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersActivity.this.originalValues.get(n)).get((Object)AnswersActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersActivity.this.originalValues.get(n)).get((Object)AnswersActivity.KEY_YANS).toString()));
                return view;
            }
