...
import com.apps.saiinfo.computerobjectivetest.ResultsengActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;
import java.util.ArrayList;

public class ResultsengActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((Button)this.findViewById(2131558598)).setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ ResultsengActivity this$0;
            {
                this.this$0 = resultsengActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((android.content.Context)this.this$0, com.apps.saiinfo.computerobjectivetest.AnswerssengActivity.class);
