...
import com.apps.saiinfo.computerobjectivetest.AnswerssysActivity;
...
public class AnswerssysActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968658);
        ...
        this.questionsList = new Databacesys((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssys)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssysActivity.this.originalValues.get(n)).get((Object)AnswerssysActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerssysActivity.this.originalValues.get(n)).get((Object)AnswerssysActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerssysActivity.this.originalValues.get(n)).get((Object)AnswerssysActivity.KEY_YANS).toString()));
                return view;
            }
