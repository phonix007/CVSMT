...
import com.apps.saiinfo.computerobjectivetest.AnswersinterActivity;
...
public class AnswersinterActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceinter((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsinter)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersinterActivity.this.originalValues.get(n)).get((Object)AnswersinterActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersinterActivity.this.originalValues.get(n)).get((Object)AnswersinterActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersinterActivity.this.originalValues.get(n)).get((Object)AnswersinterActivity.KEY_YANS).toString()));
                return view;
            }
