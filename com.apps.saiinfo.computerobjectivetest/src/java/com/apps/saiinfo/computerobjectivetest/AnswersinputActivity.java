...
import com.apps.saiinfo.computerobjectivetest.AnswersinputActivity;
...
public class AnswersinputActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceinput((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsinput)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersinputActivity.this.originalValues.get(n)).get((Object)AnswersinputActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersinputActivity.this.originalValues.get(n)).get((Object)AnswersinputActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersinputActivity.this.originalValues.get(n)).get((Object)AnswersinputActivity.KEY_YANS).toString()));
                return view;
            }
