...
import com.apps.saiinfo.computerobjectivetest.SystemMarActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class SystemMarActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968796);
        ...
        this.test1.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ SystemMarActivity this$0;
            {
                this.this$0 = systemMarActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignsysmActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignmunitActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignmsysActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
