...
import com.apps.saiinfo.computerobjectivetest.AnswerssechindiActivity;
...
public class AnswerssechindiActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databacesechindi((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssechindi)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssechindiActivity.this.originalValues.get(n)).get((Object)AnswerssechindiActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("\u0938\u0939\u0940 \u091c\u0935\u093e\u092c: " + ((HashMap)AnswerssechindiActivity.this.originalValues.get(n)).get((Object)AnswerssechindiActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("\u0906\u092a\u0915\u093e \u091c\u0935\u093e\u092c: " + ((HashMap)AnswerssechindiActivity.this.originalValues.get(n)).get((Object)AnswerssechindiActivity.KEY_YANS).toString()));
                return view;
            }
