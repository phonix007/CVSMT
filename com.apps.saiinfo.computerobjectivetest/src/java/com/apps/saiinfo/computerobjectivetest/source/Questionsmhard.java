...
public class Questionsmhard {
    ...
    public Questionsmhard(String string2, String string3, String string4, String string5, String string6, String string7) {
