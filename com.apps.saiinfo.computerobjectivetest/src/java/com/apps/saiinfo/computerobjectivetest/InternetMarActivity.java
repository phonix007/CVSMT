...
import com.apps.saiinfo.computerobjectivetest.InternetMarActivity;

public class InternetMarActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.test1.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ InternetMarActivity this$0;
            {
                this.this$0 = internetMarActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignintmActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignnetmActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignintermActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
