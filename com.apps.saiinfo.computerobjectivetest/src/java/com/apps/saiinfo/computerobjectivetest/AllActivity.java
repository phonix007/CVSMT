...
import com.apps.saiinfo.computerobjectivetest.AllActivity;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.test1.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignallActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignallengActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesigneallActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
