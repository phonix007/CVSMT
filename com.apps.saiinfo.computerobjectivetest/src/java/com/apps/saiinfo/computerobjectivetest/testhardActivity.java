...
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968798);
        ...
        this.test1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)testhardActivity.this, DesignehardActivity.class);
                testhardActivity.this.startActivity(intent);
            }
        });
        this.test2.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)testhardActivity.this, DesignhardActivity.class);
                testhardActivity.this.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)testhardActivity.this, DesignsoftActivity.class);
                testhardActivity.this.startActivity(intent);
            }
        });
    }
