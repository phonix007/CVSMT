...
import com.apps.saiinfo.computerobjectivetest.AnswersnetActivity;
...
public class AnswersnetActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968644);
        ...
        this.questionsList = new Databacenet((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsnet)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersnetActivity.this.originalValues.get(n)).get((Object)AnswersnetActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersnetActivity.this.originalValues.get(n)).get((Object)AnswersnetActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersnetActivity.this.originalValues.get(n)).get((Object)AnswersnetActivity.KEY_YANS).toString()));
                return view;
            }
