...
import com.apps.saiinfo.computerobjectivetest.DesignmunitActivity;
import com.apps.saiinfo.computerobjectivetest.data.Databacemunit;
...
public class DesignmunitActivity
extends AppCompatActivity {
    ...
    private Questionsmunit currentQuestion;
    private int obtainedScore = 0;
    ImageButton pc;
    private int questionId = 0;
    private List<Questionsmunit> questionsList;
    ...
    static /* synthetic */ Questionsmunit access$000(DesignmunitActivity designmunitActivity) {
        return designmunitActivity.currentQuestion;
    }

    static /* synthetic */ Questionsmunit access$002(DesignmunitActivity designmunitActivity, Questionsmunit questionsmunit) {
        designmunitActivity.currentQuestion = questionsmunit;
        return questionsmunit;
    }

    static /* synthetic */ int access$100(DesignmunitActivity designmunitActivity) {
        return designmunitActivity.obtainedScore;
    }

    static /* synthetic */ int access$108(DesignmunitActivity designmunitActivity) {
        int n = designmunitActivity.obtainedScore;
        designmunitActivity.obtainedScore = n + 1;
        return n;
    }

    static /* synthetic */ int access$200(DesignmunitActivity designmunitActivity) {
        return designmunitActivity.questionId;
    }

    static /* synthetic */ List access$300(DesignmunitActivity designmunitActivity) {
        return designmunitActivity.questionsList;
    }

    static /* synthetic */ void access$400(DesignmunitActivity designmunitActivity) {
        designmunitActivity.setQuestionsView();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.init();
        Databacemunit databacemunit = new Databacemunit((Context)this);
        this.questionsList = databacemunit.getAllQuestions();
        this.currentQuestion = (Questionsmunit)this.questionsList.get(this.questionId);
        this.setQuestionsView();
        this.btnSubmit.setOnClickListener(new View.OnClickListener(this, databacemunit){
            final /* synthetic */ DesignmunitActivity this$0;
            final /* synthetic */ Databacemunit val$databace;
            {
                this.this$0 = designmunitActivity;
                this.val$databace = databacemunit;
            }
            ...
            public void onClick(View view) {
                ...
                if (radioButton != null) {
                    android.util.Log.e((String)"Answer", (String)(DesignmunitActivity.access$000(this.this$0).getANSWER() + " -- " + (Object)radioButton.getText()));
                    this.this$0.AnsList.add((Object)("" + (Object)radioButton.getText()));
                    if (DesignmunitActivity.access$000(this.this$0).getANSWER().equals((Object)radioButton.getText())) {
                        DesignmunitActivity.access$108(this.this$0);
                        android.util.Log.e((String)"comments", (String)"Correct Answer");
                        android.util.Log.d((String)"score", (String)("Obtained score " + DesignmunitActivity.access$100(this.this$0)));
                    } else {
                        android.util.Log.e((String)"comments", (String)"Wrong Answer");
                    }
                    if (DesignmunitActivity.access$200(this.this$0) < this.val$databace.rowCount()) {
                        DesignmunitActivity.access$002(this.this$0, (Questionsmunit)DesignmunitActivity.access$300(this.this$0).get(DesignmunitActivity.access$200(this.this$0)));
                        DesignmunitActivity.access$400(this.this$0);
                    } else {
                        android.content.Intent intent = new android.content.Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.ResultmunitActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("score", DesignmunitActivity.access$100(this.this$0));
                        bundle.putInt("totalQs", DesignmunitActivity.access$300(this.this$0).size());
