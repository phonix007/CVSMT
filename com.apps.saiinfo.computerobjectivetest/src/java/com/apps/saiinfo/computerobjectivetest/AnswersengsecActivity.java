...
import com.apps.saiinfo.computerobjectivetest.AnswersengsecActivity;
...
public class AnswersengsecActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceengsec((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsengsec)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersengsecActivity.this.originalValues.get(n)).get((Object)AnswersengsecActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersengsecActivity.this.originalValues.get(n)).get((Object)AnswersengsecActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersengsecActivity.this.originalValues.get(n)).get((Object)AnswersengsecActivity.KEY_YANS).toString()));
                return view;
            }
