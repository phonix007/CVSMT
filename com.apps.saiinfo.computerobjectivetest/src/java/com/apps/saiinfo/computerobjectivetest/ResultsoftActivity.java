...
import com.apps.saiinfo.computerobjectivetest.ResultsoftActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;
import java.util.ArrayList;

public class ResultsoftActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ((Button)this.findViewById(2131558598)).setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ ResultsoftActivity this$0;
            {
                this.this$0 = resultsoftActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((android.content.Context)this.this$0, com.apps.saiinfo.computerobjectivetest.AnswerssoftActivity.class);
