    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.test1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)testhindi.this, DesignhActivity.class);
                testhindi.this.startActivity(intent);
            }
        });
        this.test2.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent intent = new Intent((Context)testhindi.this, DesigninhActivity.class);
                testhindi.this.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)testhindi.this, DesigninhiActivity.class);
                testhindi.this.startActivity(intent);
            }
        });
    }
