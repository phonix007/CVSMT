...
import com.apps.saiinfo.computerobjectivetest.AnswersallengActivity;
...
public class AnswersallengActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databacealleng((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsalleng)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersallengActivity.this.originalValues.get(n)).get((Object)AnswersallengActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersallengActivity.this.originalValues.get(n)).get((Object)AnswersallengActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersallengActivity.this.originalValues.get(n)).get((Object)AnswersallengActivity.KEY_YANS).toString()));
                return view;
            }
