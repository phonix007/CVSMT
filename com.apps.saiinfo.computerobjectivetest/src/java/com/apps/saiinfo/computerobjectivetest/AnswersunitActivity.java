...
import com.apps.saiinfo.computerobjectivetest.AnswersunitActivity;
...
public class AnswersunitActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databaceunit((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionsunit)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswersunitActivity.this.originalValues.get(n)).get((Object)AnswersunitActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswersunitActivity.this.originalValues.get(n)).get((Object)AnswersunitActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswersunitActivity.this.originalValues.get(n)).get((Object)AnswersunitActivity.KEY_YANS).toString()));
                return view;
            }
