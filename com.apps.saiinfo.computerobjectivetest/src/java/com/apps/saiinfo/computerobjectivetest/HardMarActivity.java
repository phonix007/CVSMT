...
import com.apps.saiinfo.computerobjectivetest.HardMarActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class HardMarActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.test1.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ HardMarActivity this$0;
            {
                this.this$0 = hardMarActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignhardmActivity.class);
        ...
        this.test2.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignmhardActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test3.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignsoftmActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
