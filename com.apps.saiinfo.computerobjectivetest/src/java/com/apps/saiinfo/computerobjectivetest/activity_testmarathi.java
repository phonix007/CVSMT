...
import com.apps.saiinfo.computerobjectivetest.activity_testmarathi;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class activity_testmarathi
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968800);
        ...
        this.test4.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ activity_testmarathi this$0;
            {
                this.this$0 = activity_testmarathi2;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignmActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test5.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ activity_testmarathi this$0;
            {
                this.this$0 = activity_testmarathi2;
            }
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesigninmActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.test6.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ activity_testmarathi this$0;
            {
                this.this$0 = activity_testmarathi2;
            }
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesigninmarActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
