...
import com.apps.saiinfo.computerobjectivetest.AnswerssyshActivity;
...
public class AnswerssyshActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968659);
        ...
        this.questionsList = new Databacesysh((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssysh)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssyshActivity.this.originalValues.get(n)).get((Object)AnswerssyshActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("\u0938\u0939\u0940 \u091c\u0935\u093e\u092c: " + ((HashMap)AnswerssyshActivity.this.originalValues.get(n)).get((Object)AnswerssyshActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("\u0906\u092a\u0915\u093e \u091c\u0935\u093e\u092c: " + ((HashMap)AnswerssyshActivity.this.originalValues.get(n)).get((Object)AnswerssyshActivity.KEY_YANS).toString()));
                return view;
            }
