...
import com.apps.saiinfo.computerobjectivetest.AnswerssecenglishActivity;
...
public class AnswerssecenglishActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.questionsList = new Databacesecenglish((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssecenglish)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssecenglishActivity.this.originalValues.get(n)).get((Object)AnswerssecenglishActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerssecenglishActivity.this.originalValues.get(n)).get((Object)AnswerssecenglishActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerssecenglishActivity.this.originalValues.get(n)).get((Object)AnswerssecenglishActivity.KEY_YANS).toString()));
                return view;
            }
