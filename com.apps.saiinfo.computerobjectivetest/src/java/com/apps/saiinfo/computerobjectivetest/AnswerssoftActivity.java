...
import com.apps.saiinfo.computerobjectivetest.AnswerssoftActivity;
...
public class AnswerssoftActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130968655);
        ...
        this.questionsList = new Databacesoft((Context)this).getAllQuestions();
        for (int i = 0; i < this.questionsList.size(); ++i) {
            this.currentQuestion = (Questionssoft)this.questionsList.get(i);
        ...
        this.adapter = new ArrayAdapter<HashMap<String, Object>>((Context)this, 2130968837, this.originalValues){
            ...
            public View getView(int n, View view, ViewGroup viewGroup) {
                ...
                this.viewHolder.Ques.setText((CharSequence)((HashMap)AnswerssoftActivity.this.originalValues.get(n)).get((Object)AnswerssoftActivity.KEY_QUES).toString());
                this.viewHolder.Correctans.setText((CharSequence)("Correct Ans: " + ((HashMap)AnswerssoftActivity.this.originalValues.get(n)).get((Object)AnswerssoftActivity.KEY_CANS).toString()));
                this.viewHolder.Yourans.setText((CharSequence)("Your Ans: " + ((HashMap)AnswerssoftActivity.this.originalValues.get(n)).get((Object)AnswerssoftActivity.KEY_YANS).toString()));
                return view;
            }
