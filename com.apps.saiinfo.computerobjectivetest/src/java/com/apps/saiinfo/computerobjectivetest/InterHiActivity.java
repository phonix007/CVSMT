...
import com.apps.saiinfo.computerobjectivetest.InterHiActivity;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;

public class InterHiActivity
extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.testa = (CardView)this.findViewById(2131558577);
        this.testb = (CardView)this.findViewById(2131558578);
        this.testc = (CardView)this.findViewById(2131558579);
        this.testa.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ InterHiActivity this$0;
            {
                this.this$0 = interHiActivity;
            }

            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesigninthActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.testb.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ InterHiActivity this$0;
            {
                this.this$0 = interHiActivity;
            }
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesignnethindiActivity.class);
                this.this$0.startActivity(intent);
            }
        });
        this.testc.setOnClickListener(new View.OnClickListener(this){
            final /* synthetic */ InterHiActivity this$0;
            {
                this.this$0 = interHiActivity;
            }
            ...
            public void onClick(View view) {
                Intent intent = new Intent((Context)this.this$0, com.apps.saiinfo.computerobjectivetest.DesigninterhActivity.class);
                this.this$0.startActivity(intent);
            }
        });
    }
